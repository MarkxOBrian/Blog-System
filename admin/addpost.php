...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $stmt = $pdo->prepare("
                INSERT INTO post (title, posttext, studentid, modulecategoryid, photo, status) 
                VALUES (?, ?, ?, ?, ?, ?)
            ");
            $stmt->execute([$title, $content, $student_id, $category_id, $photo, $status]);
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="student_id" name="student_id" required>
                                            ...
                                            <?php foreach ($students as $student): ?>
                                                <option value="<?php echo $student['studentid']; ?>" <?php echo (isset($_POST['student_id']) && $_POST['student_id'] == $student['studentid']) ? 'selected' : ''; ?>>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="category_id" name="category_id" required>
                                            ...
                                            <?php foreach ($categories as $category): ?>
                                                <option value="<?php echo $category['modulecategoryid']; ?>" <?php echo (isset($_POST['category_id']) && $_POST['category_id'] == $category['modulecategoryid']) ? 'selected' : ''; ?>>
