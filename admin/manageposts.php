...
try {
    // Get all posts with student and category information
    $stmt = $pdo->query("
    ...
    error_log("Database error in manage posts: " . $e->getMessage());
    $error_message = "An error occurred while loading posts. Please try again later.";
}
?>
                        ...
                        <div class="card h-100 post-card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text text-muted">
                                    <small>
                                        Author: <?php echo htmlspecialchars($post['studentname']); ?><br>
